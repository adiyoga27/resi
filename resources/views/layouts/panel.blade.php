                                        ...
                                        <div class="message-center message-body position-relative"
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3">
                                                    <h5 class="message-title mb-0 mt-1 fs-3 font-weight-medium">Pavan kumar</h5> <span
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3">
                                                    <h5 class="message-title mb-0 mt-1 fs-3 font-weight-medium">Sonu Nigam</h5> <span
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3">
                                                    <h5 class="message-title mb-0 mt-1 fs-3 font-weight-medium">Arijit Sinh</h5> <span
                                    ...
                                    <li>
                                        <div class="message-center notifications position-relative"
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3">
                                                    <h5 class="message-title mb-0 mt-1 fs-3 font-weight-medium">Luanch Admin</h5> <span
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3">
                                                    <h5 class="message-title mb-0 mt-1 fs-3 font-weight-medium">Event today</h5> <span
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3">
                                                    <h5 class="message-title mb-0 mt-1 fs-3 font-weight-medium">Settings</h5> <span
                                                        class="fs-2 text-nowrap d-block time text-truncate fw-normal text-muted mt-1">You can
                                                        customize this</span> <span
                                                        class="fs-2 text-nowrap d-block subtext text-muted">9:08 AM</span>
                                                </div>
                                            </a>
                                            <!-- Message -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-3 bg-primary text-white mb-2">
                                    <div class=""><img src="{{url('assets')}}/images/users/5.jpg" alt="user" class="rounded-circle" width="60"></div>
                                    <div class="ms-2">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="sidebar-type-iconsidebar.html" class="sidebar-link">
                                        ...
                                        <span class="hide-menu"> NON COD </span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <div class="message-center chat-scroll position-relative">
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/1.jpg" alt="user" class="rounded-circle w-100">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/2.jpg" alt="user" class="rounded-circle w-100">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/3.jpg" alt="user" class="rounded-circle w-100">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/4.jpg" alt="user" class="rounded-circle w-100">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/5.jpg" alt="user" class="rounded-circle w-100">
                                        <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle ps-3">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/6.jpg" alt="user" class="rounded-circle w-100">
                                        <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle ps-3">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/7.jpg" alt="user" class="rounded-circle w-100">
                                        <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle ps-3">
                                        <h5 class="message-title mb-0 mt-1">Pavan kumar</h5> <span
                                            class="fs-2 text-nowrap d-block text-muted text-truncate">Just see the my
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="user-img position-relative d-inline-block"> <img
                                            src="{{url('assets')}}/images/users/8.jpg" alt="user" class="rounded-circle w-100">
                                        <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle ps-3">
                    ...
                    <div class="steamline">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{url('assets')}}/images/users/2.jpg"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{url('assets')}}/images/users/1.jpg"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{url('assets')}}/images/users/4.jpg"> </div>
                            <div class="sl-right">
                                <div class="font-weight-medium">Go to the Doctor <span class="sl-date">5 minutes
                                        ago</span>
                                </div>
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{url('assets')}}/images/users/6.jpg"> </div>
                            <div class="sl-right">
                                <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span>
                                </div>
                                <div class="desc">Approve meeting with tiger</div>
